                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Diabetic Plus</h1>
                                <p className="step-subtitle">Track daily logs, blood sugar charts, activity records, and symptoms completely offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Log blood sugar readings and view visual charts</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Plan meals, calculate diabetes risk scores, and check medical guidelines</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Keep symptoms and activity logs saved securely on your device</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
