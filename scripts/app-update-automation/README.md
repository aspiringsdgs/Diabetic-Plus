...
| **Mobile MSC Template** | `templates.mobile.mscJsonPath` | Copies JSON to `public/templates/data/mobile.json` |
| **Tablet MSC Template** | `templates.tablet.mscJsonPath` | Copies JSON to `public/templates/data/tablet.json` |
