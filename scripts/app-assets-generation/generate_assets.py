...
def process_branding(root_dir):
    source_icon = os.path.join(root_dir, 'scripts/app-update-automation/templates/icon.png')
    source_splash = os.path.join(root_dir, 'scripts/app-update-automation/templates/splash.png')
